...
for i, row in subjects.iterrows():
	...
	#oPath = '/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/sub-{}/ses-{}/anat'.format(row.subject_id, row.session_id)
	...
	try:
		...
		if not os.path.exists(os.path.join(iPath, oT2w_file)):
			aims.write(oT2w, os.path.join(iPath, oT2w_file))
