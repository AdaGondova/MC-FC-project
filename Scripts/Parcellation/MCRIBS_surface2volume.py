...
### for now, initiate the old version of bv environment: /i2bm/brainvisa/brainvisa-cea-5.0.4/bin/bv 
...
def get_trm_file(subject_id, session_id):
	...
	conv_out = '/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-{}/ses-{}/sub-{}_ses-{}_T2w.ima'.format(subject_id, session_id, subject_id, session_id)
	...
	for line in file.readlines():
		if 'transformations' in line:
			...
			to_save = '/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-{}/ses-{}/sub-{}_ses-{}.trm'.format(subject_id,session_id, subject_id, session_id)
...
def transform_surfaces(subject_id, session_id, path_to_trm):
	...
	out_names = [
	'/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-{}/ses-{}/sub-{}_ses-{}_T2w_Rwhite_transformed.gii'.format(subject_id,session_id, subject_id, session_id),
	'/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-{}/ses-{}/sub-{}_ses-{}_T2w_Rhemi_transformed.gii'.format(subject_id,session_id, subject_id, session_id),
	'/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-{}/ses-{}/sub-{}_ses-{}_T2w_Lwhite_transformed.gii'.format(subject_id,session_id, subject_id, session_id),
	'/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-{}/ses-{}/sub-{}_ses-{}_T2w_Lhemi_transformed.gii'.format(subject_id,session_id, subject_id, session_id)	
	]
...
def combined_hemispheres(subject_id, session_id):
	...
	print('Trying to merge the file: {}'.format(oVol))
