...
do
	...
	#iParcDKT=/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-${subject}/ses-${session}/sub-${subject}_ses-${session}.combined.DKT.volume.nii.gz
	#iParcDKT_dHCP_dil=/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-${subject}/ses-${session}/sub-${subject}_ses-${session}.dilated.combined.DKT-DRAWEM.volume.anat.nii.gz
	iParcDKT_dHCP_non_dil_sub=/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-${subject}/ses-${session}/sub-${subject}_ses-${session}.combined.DKT-DRAWEM.volume.anat.nii.gz
	...
	oDir=/neurospin/grip/external_databases/dHCP_CR_JD_2018/Projects/networks/DerivedData/subjects/sub-${subject}/ses-${session}
	...
	#oParcDKT_dHCP_dil=${oDir}/sub-${subject}_ses-${session}.dilated.combined.DKT-DRAWEM.volume.shard.nii.gz
	oParcDKT_dHCP_non_dil_sub=${oDir}/sub-${subject}_ses-${session}.combined.DKT-DRAWEM.volume.shard.nii.gz
	oRibbon=${oDir}/sub-${subject}_ses-${session}_desc-ribbon_dseg_shard.nii.gz
